...
export interface ApiAboutUniversityAboutUniversity
  extends Struct.CollectionTypeSchema {
  collectionName: 'about_universities';
  info: {
    displayName: 'AboutUniversity';
    pluralName: 'about-universities';
    singularName: 'about-university';
  };
  options: {
...
export interface ApiUniversityFacultiesUniversityFaculties
  ...
  attributes: {
    ...
    ProgramOverview: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiUniversityHistoryUniversityHistory
  extends Struct.CollectionTypeSchema {
  collectionName: 'university_histories';
  info: {
    displayName: 'UniversityHistory ';
    pluralName: 'university-histories';
    singularName: 'university-history';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::university-history.university-history'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiUniversityInfoUniversityInfo
  extends Struct.CollectionTypeSchema {
  collectionName: 'university_infos';
  info: {
    displayName: 'UniversityInfo';
    pluralName: 'university-infos';
    singularName: 'university-info';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::university-info.university-info'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visionmission: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
